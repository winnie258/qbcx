...
<!-- Logo -->
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <h4 class="text-dark-50 text-center mt-0 font-weight-bold">Q绑在线查询</h4>
                                      
                                </div>
                                <br>
                                
                                  <label for="mobile">QQ号码</label>
                                        <input class="form-control" type="text" id="input" placeholder="请输入需要查询的QQ号码...">
